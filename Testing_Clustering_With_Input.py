...
file_name_clustering_data =  "DataForClustering_Without_Study_CategoryDuration.csv"
...
clusters = kproto.fit_predict(streamlit_kprot_data, categorical=categorical_indices)
st.write("Cost of model with 3 clusters: ", kproto.cost_)
